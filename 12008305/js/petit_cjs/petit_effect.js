(function(cjs, an) {
    ...
    (lib.エフェクト_レベルアップ = function(mode, startPosition, loop) {
        ...
        // timeline functions:
        this.frame_0 = function() {/* if(/:heartFlg != 1) {
			_visible=0
		}*/
        }
        this.frame_15 = function() {
    ...
    (lib.effect_set_base = function(mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(19).to({
            _off: false
        }, 0).to({
            _off: true
        }, 32).wait(48));
        ...
        this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(19).to({
            _off: false
        }, 0).wait(1).to({
            alpha: 1
        }, 30).to({
        ...
        this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_1).wait(19).to({
            _off: false
        }, 0).wait(1).to({
            alpha: 0.4492
        }, 30).to({
        ...
        this.timeline.addTween(cjs.Tween.get(this.grip).to({
            _off: true
        }, 1).wait(98));
    ...
    lib.properties = {
        ...
        opacity: 1.00,
        manifest: [{
            src: "images/petit_effect_atlas_.png?1612763057881",
