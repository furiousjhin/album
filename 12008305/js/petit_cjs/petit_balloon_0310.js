(function(cjs, an) {
    ...
    lib.ssMetadata = [{
        ...
        frames: [[0, 0, 624, 180], [626, 0, 72, 140], [610, 182, 72, 140], [610, 324, 72, 80], [732, 122, 72, 60], [684, 264, 72, 60], [0, 182, 608, 168], [700, 0, 46, 120], [684, 142, 46, 120], [732, 184, 46, 60], [748, 0, 46, 40], [748, 42, 46, 40]]
    }];
    ...
    (lib.cjs005_balloon = function(mode, startPosition, loop) {
        ...
        this.frame_0 = function() {
            ...
            this.speak_type_num = 0;
            //吹き出しのタイプを変えるための固定値 0 or 5
            this.speak_foward = 0;
            //0:デフォルト  1:モニター時に上にいるキャラ用
    ...
    (lib.petit_balloon = function(mode, startPosition, loop) {
        ...
        this.frame_1 = function() {/* //call( "init" );
		stop();*/
        }
