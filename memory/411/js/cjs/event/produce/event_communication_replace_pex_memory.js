(function(a, k) {
    ...
    ).prototype = g(b.replace_bg_1, new a.Rectangle(0,-27,240,310), null);
    ...
    ).prototype = g(b._txt_rst2_w, new a.Rectangle(-66.5,-27.3,133,54.6), null);
    ...
    ).prototype = g(b._txt_rst1, new a.Rectangle(-66.5,-27.3,133,54.6), null);
    ...
    ).prototype = g(b._ch_replace3, new a.Rectangle(0,0,240,320), null);
    ...
    ).prototype = g(b.result_base, new a.Rectangle(-144,50.8,280,63), null);
    ...
    f.nominalBounds = new a.Rectangle(-32,-32,180,64);
    ...
    (b.event_communication_replace_pex_memory = function(c, d, e) {
        ...
        this.frame_0 = function() {
            ...
            this.boot_effect = function() {
                var l = this["s" + this.scene_m + "_" + this.scene_s + "_ch" + this.count_ch + "_chara_effect"];
                if (0 < l) {
                    var n = this.t_pos
        ...
        this.frame_7 = function() {
            ...
            this.ch2.x = 30,
            this.ch_back.x = -70) : (this.ch.x = -70,
            this.ch2.x = 30,
        ...
        this.ch2.setTransform(-350, -10.4, 1, 1, 0, 0, 0, 0, -.4);
    ...
    k.bootstrapCallback = function(c) {
        ...
        if (0 < k.bootcompsLoaded.length)
            for (var d = 0; d < k.bootcompsLoaded.length; ++d)
                c(k.bootcompsLoaded[d])
    }
    ;
    ...
    k.compositionLoaded = function(c) {
        ...
        for (var d = 0; d < k.bootstrapListeners.length; d++)
            k.bootstrapListeners[d](c)
    }
    ;
    ...
    k.makeResponsive = function(c, d, e, l, n) {
        function p() {
            var q = b.properties.width
              ...
              , m = 1;
            if (c)
                if ("width" == d && y == t || "height" == d && z == u)
                    m = A;
                else if (e)
                    1 == l ? m = Math.min(w, x) : 2 == l && (m = Math.max(w, x));
                else if (t < q || u < r)
                    m = Math.min(w, x);
            n[0].width = q * v * m;
            n[0].height = r * v * m;
